...
class Mbs_Abandonedcart_Model_Observer {
    ...
    public function sendReminderEmails() {
        ...
        foreach( $quotes as $quote ) {
            ...
            $optout = $customer->getData('optout');
            ...
            if($optout != '1') {
                ...
                if($orders->count() == 0 /*&& $quote->getCustomerEmail() == "twaelbroeck@gmail.com"*/) {
                    ...
                    if(!empty($templateData) && $customerEmail == 'travis.w@mbs-standoffs.com') {
            ...
            } else {Mage::log("Customer opted out of Abandoned Cart Email Reminders",null,"test.log");}
        }
    }
}
