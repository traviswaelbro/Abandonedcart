...
class Mbs_Abandonedcart_Model_Adminhtml_System_Config_Source_Cron_Frequency
{

    protected static $_options;

    const CRON_PER_HOUR = 'P';
    const CRON_HOURLY   = 'H';
    const CRON_DAILY    = 'D';
    const CRON_WEEKLY   = 'W';
    ...
    public function toOptionArray()
    {
        if (!self::$_options) {
            self::$_options = array(
                array(
                    'label' => Mage::helper('cron')->__('Every X Minutes'),
                    'value' => self::CRON_PER_HOUR,
                ),
                array(
